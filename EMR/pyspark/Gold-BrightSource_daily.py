...
exp_step1_df_sites_metadata = df_sites_metadata.select("Id",
                                               ...
                                               .withColumn("Latitude", 0)\
                                               .withColumn("Longitude", 0)
