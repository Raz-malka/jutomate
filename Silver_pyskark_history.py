...
with DAG(
    dag_id='emr_job_flow_manual_steps_dag_silver_history',
        ...
        SPARK_STEPS = [
            {
                ...
                'HadoopJarStep': {
                    ...
                    'Args': ["spark-submit","--deploy-mode","cluster","s3://pyspark-script/Silver-BrightSource_history.py","--date_t",str(date_t)],
                },
            }
        ]
    ...
    #Running the gold history dag
    run_gold_history = TriggerDagRunOperator(
            task_id='run_gold_history',
            trigger_dag_id='emr_job_flow_manual_steps_dag_gold_history',
            wait_for_completion=True,
            trigger_rule=TriggerRule.ALL_DONE
        )

    cluster_remover >> Updating_tables >> run_gold_history